...
pig /home/hadoop/geni/geni_combine.pig


rm -rf /home/hadoop/geni/geni-results  > /dev/null 2> /dev/null
hadoop dfs -copyToLocal /user/hadoop/results/geni-combine/traffic_percent_per_protocol/part-m-00000 /home/hadoop/geni/geni-results
