...
A = LOAD 'hdfs://UCSD-1:54310/user/hadoop/results/geni/total_traffic/part-r-00000' USING PigStorage('\t') AS (title:chararray, total:double);

B = LOAD 'hdfs://Kaiserslautern-1:54310/user/hadoop/results/geni/total_traffic/part-r-00000' USING PigStorage('\t') AS (title:chararray, total:double);
...
F = LOAD 'hdfs://UCSD-1:54310/user/hadoop/results/geni/total_traffic_per_known_protocol/part-r-00000' USING PigStorage('\t') AS (protocol:chararray, protocol_total:double);

G = LOAD 'hdfs://Kaiserslautern-1:54310/user/hadoop/results/geni/total_traffic_per_known_protocol/part-r-00000' USING PigStorage('\t') AS (protocol:chararray, protocol_total:double);
...
L = LOAD 'hdfs://UCSD-1:54310/user/hadoop/results/geni/total_known_traffic/part-r-00000' USING PigStorage('\t') AS (title:chararray, total_known_traffic:double);

M = LOAD 'hdfs://Kaiserslautern-1:54310/user/hadoop/results/geni/total_known_traffic/part-r-00000' USING PigStorage('\t') AS (title:chararray, total_known_traffic:double);
